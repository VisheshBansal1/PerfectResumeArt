...
class AppNavigationDrawer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final unreadCount = ref.watch(unreadReferralNotificationsProvider).maybeWhen(
      data: (c) => c,
      orElse: () => 0,
    );
              ...
              child: ListView(
                ...
                children: [
                  _DrawerItem(
                    ...
                    label: 'Home',
                    onTap: () => _closeThen(context, () => context.go(AppRoutes.home)),
                  ),
                  _DrawerItem(
                    icon: Icons.auto_awesome,
                    label: 'Analyze for Job',
                    onTap: () => _closeThen(context, () => context.push(AppRoutes.uploadResume)),
                  ),
                  _DrawerItem(
                    icon: Icons.fact_check_outlined,
                    label: 'ATS Checker',
                    onTap: () => _closeThen(context, () => context.push(AppRoutes.atsChecker)),
                  ),
                  _DrawerItem(
                    icon: Icons.manage_search,
                    label: 'JD Keyword Match',
                    onTap: () => _closeThen(context, () => context.push(AppRoutes.jdKeywordMatch)),
                  ),
                  _DrawerItem(
                  ...
                  _DrawerItem(
                    ...
                    label: 'My Progress',
                    onTap: () => _closeThen(context, () => context.push(AppRoutes.progress)),
                  ),
                  _DrawerItem(
                    ...
                    onTap: () => _closeThen(
                      ...
                      () => Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const PremiumHubScreen(resumeText: '')),
                      ),
                    ),
                  ),
                  _DrawerItem(
                    ...
                    onTap: () => _closeThen(context, () => context.push(AppRoutes.earnRefer)),
                  ),
                  const Padding(
                  ...
                  _DrawerItem(
                    ...
                    label: 'Profile',
                    onTap: () => _closeThen(context, () => context.push(AppRoutes.profile)),
                  ),
                  _DrawerItem(
                    icon: Icons.support_agent_outlined,
                    label: 'Contact Us',
                    onTap: () => _closeThen(context, () => context.push(AppRoutes.contactUs)),
                  ),
                  if (user?.role == 'admin')
                    _DrawerItem(
                      icon: Icons.admin_panel_settings_outlined,
                      label: 'Referral Program Admin',
                      onTap: () => _closeThen(context, () => context.push(AppRoutes.referralAdmin)),
                    ),
                ],
              ),
            ),
...
class _DrawerItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(
        label,
        style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.w500, color: labelColor),
      ),
