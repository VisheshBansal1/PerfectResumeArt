...
class _AtsCheckerScreenState extends ConsumerState<AtsCheckerScreen> {
  ...
  Future<void> _pickFile() async {
    ...
    if (result != null && result.files.single.path != null) {
      ...
      await ref.read(resumeUploadProvider.notifier).extractText(_selectedFile!);
    }
  }
  ...
  Widget _buildChecklist() => Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          ...const [
            ('Formatting & Structure', 'Clean sections, no complex tables/graphics', Icons.format_align_left),
            ('Keywords & Action Verbs', 'Industry-standard terminology', Icons.key_outlined),
            ('Contact Information', 'Complete and properly placed', Icons.contact_page_outlined),
            ('Quantifiable Achievements', 'Numbers and impact metrics', Icons.trending_up),
            ('Section Headers', 'Standard ATS-readable headers', Icons.view_headline),
            ('Length & Consistency', 'Appropriate length, uniform formatting', Icons.straighten),
            ...
            child: Column(
              children: [
                Icon(Icons.upload_file_outlined,
                    size: 36, color: Colors.purple.withOpacity(0.7)),
                const SizedBox(height: 10),
                const Text('Tap to select resume',
  ...
  Widget _buildRunButton(dynamic uploadState) => SizedBox(
        ...
        child: ElevatedButton.icon(
          onPressed: _selectedFile != null && !uploadState.isLoading ? _runAtsCheck : null,
...
class _ChecklistItem extends StatelessWidget {
  ...
  final IconData icon;
  const _ChecklistItem({required this.title, required this.subtitle, required this.icon});
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(
          children: [
            ...
            Icon(Icons.check_circle_outline, color: Colors.purple.withOpacity(0.4), size: 18),
          ],
        ),
      );
}
